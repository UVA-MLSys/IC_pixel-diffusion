...
# python evaluate.py --root ../Datasets --model_folder ./run/standard_32 --kmax 0.1 --target_type quijote_ic_32 --unnormalize_sample
# python evaluate.py --root ../Datasets --model_folder ./run/standard_64 --kmax 0.2 --target_type quijote_ic_64 --unnormalize_sample

# python evaluate.py --root ../Datasets --model_folder ./run/bsq_32 --kmax 0.1 --target_type bsq_ic_32 --start 900 --end 1000 --unnormalize_sample
# python evaluate.py --root ../Datasets --model_folder ./run/bsq_64 --kmax 0.2 --target_type bsq_ic_64 --start 900 --end 1000 --unnormalize_sample
# python evaluate.py --root ../Datasets --model_folder ./run/bsq_128 --kmax 0.4 --target_type bsq_ic_128 --start 900 --end 1000 --unnormalize_sample

# python evaluate.py --root ../Datasets --model_folder ./run/lc_32 --kmax 0.1 --target_type lc_ic_32 --start 900 --end 1000 --unnormalize_sample
# python evaluate.py --root ../Datasets --model_folder ./run/lc_64 --kmax 0.2 --target_type lc_ic_64 --start 900 --end 1000 --unnormalize_sample
# python evaluate.py --root ../Datasets --model_folder ./run/lc_128 --kmax 0.4 --target_type lc_ic_128 --start 900 --end 1000 --unnormalize_sample
