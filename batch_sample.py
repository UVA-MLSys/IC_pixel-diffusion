...
# 1-1.30h
# python batch_sample.py --config ./configs/bsq_32.json --start 900 --end 1000

# python batch_sample.py --config ./configs/bsq_32.json --start 900 --end 1000
# python batch_sample.py --config ./configs/bsq_64.json --start 900 --end 1000
# python batch_sample.py --config ./configs/bsq_128.json --start 900 --end 1000

# python batch_sample.py --config ./configs/lc_32.json --start 900 --end 1000
# python batch_sample.py --config ./configs/lc_64.json --start 900 --end 1000
# python batch_sample.py --config ./configs/lc_128.json --start 900 --end 1000
...
def get_parser():
    ...
    parser.add_argument('--config', type=str, default='./configs/standard_128.json', help='Configuration file')
    parser.add_argument(
...
if args.benchmark:
    ...
    benchmark_file = os.path.join(model_folder_bench, f"inference_benchmark_{world_size}_sde.csv")
